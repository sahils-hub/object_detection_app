...
1. The YOLOv8 model detects objects in each frame or image.  
2. Detected labels and bounding boxes are drawn using OpenCV.  
3. Results are displayed in Streamlit with object counts and bar charts.  
4. For webcam input, frames are processed in real time via **streamlit-webrtc**.
...
- Use smaller frame sizes (e.g., **640×480**) to improve FPS.
...
**Sahil Kamble**  
📧 Email: [sahilkamble0134@gmail.com](mailto:sahilkamble0134@gmail.com)  
🌐 GitHub: [github.com/sahils-hub](https://github.com/sahils-hub)
